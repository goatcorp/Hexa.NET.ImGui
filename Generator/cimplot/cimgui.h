...
struct ImFontAtlas
{
    ...
    unsigned int                FontBuilderFlags;
    int                         TextureIndexCommon;
    int                         PackIdCommon;
    ImFontAtlasCustomRect       RectMouseCursors;
    ImFontAtlasCustomRect       RectLines;
};
...
CIMGUI_API ImTextureID igGetFontTexIdWhitePixel(void);
